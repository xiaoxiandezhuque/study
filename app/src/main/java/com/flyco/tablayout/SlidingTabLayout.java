...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private TabOnPageChangeCallBack  mTabOnPageChangeCallBack;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabOnPageChangeCallBack = new TabOnPageChangeCallBack(this);
    }
    ...
    public void setViewPager(ViewPager2 vp) {
        ...
        if (mViewPager != null) {
            this.mViewPager.unregisterOnPageChangeCallback(mTabOnPageChangeCallBack);
        }
        this.mViewPager = vp;
        this.mViewPager.registerOnPageChangeCallback(mTabOnPageChangeCallBack);
    ...
    public void setViewPager(ViewPager2 vp, String[] titles) {
        ...
        mViewPager.registerOnPageChangeCallback(mTabOnPageChangeCallBack);
        notifyDataSetChanged();
    }
...
//     */
//    public void setViewPager(ViewPager vp, String[] titles, AppCompatActivity fa, ArrayList<Fragment> fragments) {
//        if (vp == null) {
