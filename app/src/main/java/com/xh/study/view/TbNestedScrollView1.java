...
import com.xh.study.util.FlingHelper;

public class TbNestedScrollView1 extends NestedScrollView {
    private View topView;
    private ViewGroup contentView;
    private static final String TAG = "NestedScrollLayout";


    public TbNestedScrollView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
